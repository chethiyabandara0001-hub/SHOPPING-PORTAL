import{r as A,i as v,Q as S,e as E,J as Y,Z as ke,F as J,w as b,m as Ce,x as Ee,O as Q,$ as X,W as Z,a0 as ee,L as Re,a1 as U}from"./index.esm-QTFHyxNk.js";const te="@firebase/installations",N="0.6.24";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xe({appConfig:e,heartbeatServiceProvider:t},n){const a=Ze(e,n),i=Oe(e,n),r=t.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&i.append("x-firebase-client",l)}const s={installation:{sdkVersion:ae,appId:e.appId}},o={method:"POST",headers:i,body:JSON.stringify(s)},c=await ue(()=>fetch(a,o));if(c.ok){const l=await c.json();return oe(l)}else throw await ce("Generate Auth Token",c)}function Ze(e,{fid:t}){return`${se(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ie="installations",ut="installations-internal",dt=e=>{const t=e.getProvider("app").getImmediate(),n=lt(t),a=E(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},ft=e=>{const t=e.getProvider("app").getImmediate(),n=E(t,Ie).getImmediate();return{getId:()=>st(n),getToken:i=>ot(n,i)}};function pt(){v(new S(Ie,dt,"PUBLIC")),v(new S(ut,ft,"PRIVATE"))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(t){this.app=t}_delete(){return delete p[this.app.options.appId],Promise.resolve()}}let p={},G=[];const z={};let T="dataLayer",Se="gtag",H,g,M=!1;function Zt(e){if(M)throw d.create("already-initialized");e.dataLayerName&&(T=e.dataLayerName),e.gtagName&&(Se=e.gtagName)}function Ht(){const e=[];if(Q()&&e.push("This is a browser extension environment."),X()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function Kt(e,t,n){Ht();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(p[a]!=null)throw d.create("already-exists",{id:a});if(!M){At(T);const{wrappedGtag:r,gtagCore:s}=Ct(p,G,z,T,Se);g=r,H=s,M=!0}return p[a]=Gt(e,G,z,t,H,T,n),new zt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qt(){v(new S(C,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Kt(a,i,n)},"PUBLIC")),v(new S("analytics-internal",e,"PRIVATE")),A(K,W),A(K,W,"esm2020");function e(t){try{const n=t.getProvider(C).getImmediate();return{logEvent:(a,i,r)=>Jt(n,a,i,r),setUserProperties:(a,i)=>Yt(n,a,i)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Qt();export{en as getAnalytics,an as getGoogleAnalyticsClientId,Wt as initializeAnalytics,tn as isSupported,Jt as logEvent,sn as setAnalyticsCollectionEnabled,cn as setConsent,nn as setCurrentScreen,on as setDefaultEventParameters,rn as setUserId,Yt as setUserProperties,Zt as settings};
